...
export const companyEntries: KnowledgeEntry[] = [
  {
    id: "services",
    topic: "ICE Alarm Services",
    keywords: ["service", "services", "offering", "provide", "help", "health", "monitoring", "servicio", "servicios", "salud", "monitoreo"],
    responses: {
      en: [
        "ICE Alarm offers comprehensive health monitoring services for elderly and vulnerable individuals, including 24/7 emergency response, medication management, and health metrics tracking.",
        ...
        "ICE Alarm provides both hardware devices and monitoring services with multilingual support specifically designed for expatriates and locals in Spain."
      ],
      es: [
        "ICE Alarm ofrece servicios completos de monitoreo de salud para personas mayores y vulnerables, incluida respuesta de emergencia 24/7, gestión de medicamentos y seguimiento de métricas de salud.",
        ...
        "ICE Alarm proporciona tanto dispositivos de hardware como servicios de monitoreo con soporte multilingüe específicamente diseñados para expatriados y locales en España."
      ]
    }
  },
  {
    id: "about",
    topic: "About ICE Alarm",
    keywords: ["about", "company", "history", "mission", "vision", "values", "sobre", "compañía", "historia", "misión", "visión", "valores"],
    responses: {
      en: [
        "ICE Alarm was founded in 2018 with a mission to provide comprehensive health monitoring services for expatriates and locals in Spain, focusing on elderly care and peace of mind for family members.",
        ...
        "At ICE Alarm, our core values include compassion, reliability, innovation, and cultural sensitivity. We believe everyone deserves access to quality healthcare monitoring regardless of language or cultural background."
      ],
      es: [
        "ICE Alarm fue fundada en 2018 con la misión de proporcionar servicios integrales de monitoreo de salud para expatriados y locales en España, centrándose en el cuidado de personas mayores y la tranquilidad para los miembros de la familia.",
        ...
        "En ICE Alarm, nuestros valores fundamentales incluyen compasión, confiabilidad, innovación y sensibilidad cultural. Creemos que todos merecen acceso a un monitoreo de salud de calidad independientemente del idioma o antecedentes culturales."
      ]
    }
  },
  {
    id: "locations",
    topic: "ICE Alarm Locations",
    keywords: ["location", "office", "address", "branch", "center", "ubicación", "oficina", "dirección", "sucursal", "centro"],
    responses: {
      en: [
        "ICE Alarm's headquarters is located in Alicante, Spain, with regional offices in Madrid, Barcelona, Valencia, and Málaga to serve clients across the country.",
      ...
      es: [
        "La sede central de ICE Alarm está ubicada en Alicante, España, con oficinas regionales en Madrid, Barcelona, Valencia y Málaga para atender a clientes en todo el país.",
  ...
  {
    id: "pricing",
    topic: "ICE Alarm Pricing",
    keywords: ["price", "pricing", "cost", "subscription", "plan", "precio", "costo", "suscripción", "plan"],
    responses: {
      en: [
        "ICE Alarm offers flexible pricing plans starting from €29.99 monthly for our basic monitoring service, with premium plans that include device rental and additional services.",
      ...
      es: [
        "ICE Alarm ofrece planes de precios flexibles desde €29.99 mensuales para nuestro servicio básico de monitoreo, con planes premium que incluyen alquiler de dispositivos y servicios adicionales.",
