...
export const supportEntries: KnowledgeEntry[] = [
  {
    id: "support",
    topic: "ICE Alarm Support",
    ...
    responses: {
      en: [
        ...
        "ICE Alarm provides multilingual support in English, Spanish, German, French, and Dutch to serve our diverse expatriate community in Spain.",
      ...
      es: [
        ...
        "ICE Alarm proporciona soporte multilingüe en inglés, español, alemán, francés y holandés para servir a nuestra diversa comunidad de expatriados en España.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "ICE Alarm's Family Portal allows authorized family members and caregivers to remotely monitor the health and safety status of their loved ones through our secure web portal or mobile app.",
      ...
      es: [
        "El Portal Familiar de ICE Alarm permite a familiares autorizados y cuidadores monitorear remotamente el estado de salud y seguridad de sus seres queridos a través de nuestro portal web seguro o aplicación móvil.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "ICE Alarm offers professional installation services for all our devices. A multilingual technician will visit your home to set up the equipment, test connections, and provide personalized training.",
      ...
      es: [
        "ICE Alarm ofrece servicios de instalación profesional para todos nuestros dispositivos. Un técnico multilingüe visitará su hogar para configurar el equipo, probar conexiones y proporcionar capacitación personalizada.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "ICE Alarm provides 24/7 technical support for all devices and services. Our multilingual support team can diagnose most issues remotely and guide you through simple troubleshooting steps.",
      ...
      es: [
        "ICE Alarm proporciona soporte técnico 24/7 para todos los dispositivos y servicios. Nuestro equipo de soporte multilingüe puede diagnosticar la mayoría de los problemas de forma remota y guiarle a través de simples pasos de solución de problemas.",
