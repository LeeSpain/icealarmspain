...
export const deviceEntries: KnowledgeEntry[] = [
  {
    ...
    responses: {
      en: [
        "ICE Alarm offers three main devices: the SOS Pendant for emergency alerts, the Medical Dispenser for automated medication management, and the Glucose Monitor for health tracking.",
      ...
      es: [
        "ICE Alarm ofrece tres dispositivos principales: el Colgante SOS para alertas de emergencia, el Dispensador Médico para gestión automatizada de medicamentos y el Monitor de Glucosa para seguimiento de salud.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "The ICE Alarm SOS Pendant features one-touch emergency calling, automatic fall detection, GPS location tracking, and water resistance - making it perfect for everyday wear and peace of mind.",
      ...
      es: [
        "El Colgante SOS de ICE Alarm cuenta con llamada de emergencia con un solo toque, detección automática de caídas, seguimiento de ubicación GPS y resistencia al agua, haciéndolo perfecto para uso diario y tranquilidad.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "The ICE Alarm Medical Dispenser can manage up to 28 days of medications with multiple daily doses, automatically dispensing the right pills at the right time and sending alerts if doses are missed.",
      ...
      es: [
        "El Dispensador Médico de ICE Alarm puede gestionar hasta 28 días de medicamentos con múltiples dosis diarias, dispensando automáticamente las pastillas correctas en el momento adecuado y enviando alertas si se omiten dosis.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "The ICE Alarm Glucose Monitor provides continuous glucose monitoring through a small, comfortable sensor worn on the body, with readings automatically transmitted to our monitoring system every 5 minutes.",
      ...
      es: [
        "El Monitor de Glucosa de ICE Alarm proporciona monitoreo continuo de glucosa a través de un sensor pequeño y cómodo que se usa en el cuerpo, con lecturas transmitidas automáticamente a nuestro sistema de monitoreo cada 5 minutos.",
