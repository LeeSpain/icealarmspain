...
export const membershipEntries: KnowledgeEntry[] = [
  {
    id: "subscription",
    topic: "ICE Alarm Subscription",
    keywords: ["subscribe", "subscription", "join", "member", "membership", "suscribir", "suscripción", "unirse", "miembro", "membresía"],
    responses: {
      en: [
        "Joining ICE Alarm is simple - you can sign up online through our website or have one of our representatives guide you through the process over the phone.",
      ...
      es: [
        "Unirse a ICE Alarm es simple - puede registrarse en línea a través de nuestro sitio web o hacer que uno de nuestros representantes le guíe a través del proceso por teléfono.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "ICE Alarm offers four membership types: Individual for single users, Couple for partners living together, Family for multiple related members, and Caregiver for professional care providers.",
      ...
      es: [
        "ICE Alarm ofrece cuatro tipos de membresía: Individual para usuarios únicos, Pareja para parejas que viven juntas, Familia para múltiples miembros relacionados y Cuidador para proveedores de cuidado profesional.",
  ...
  },
  {
    ...
    responses: {
      en: [
        "ICE Alarm takes data privacy extremely seriously. We are fully GDPR compliant and implement end-to-end encryption for all personal and health data transmitted through our systems.",
      ...
      es: [
        "ICE Alarm toma la privacidad de datos extremadamente en serio. Cumplimos completamente con el GDPR e implementamos cifrado de extremo a extremo para todos los datos personales y de salud transmitidos a través de nuestros sistemas.",
