  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow">
        ...
        {/* NEW: Call Center Support Section */}
        <section className="py-20 bg-ice-50/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-playfair font-bold mb-6 bg-gradient-to-r from-gray-900 via-ice-900 to-guardian-800 bg-clip-text text-transparent">
