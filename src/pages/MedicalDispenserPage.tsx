...
import { 
  PlusSquare, Smartphone, Wifi, Shield,
  Check, Pill, Clock, ArrowRight, Sparkles, Bell
} from "lucide-react";
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="mb-8">
                  <PlusSquare className="w-16 h-16 text-guardian-500" />
                </div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  {language === 'en'
                    ? "Our smart Medical Dispenser provides automated medication management with intelligent reminders and adherence tracking. The system can alert caregivers or family members when doses are missed."
                    : "Nuestro Dispensador Médico inteligente proporciona gestión automatizada de medicamentos con recordatorios inteligentes y seguimiento de adherencia. El sistema puede alertar a cuidadores o familiares cuando se omiten dosis."}
                </p>
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div>
                    <p className="text-2xl font-bold text-orange-600">€249.99</p>
              ...
              <div className="relative">
                <img 
                  ...
                  alt={language === 'en' ? "Medical Dispenser" : "Dispensador Médico"}
                ...
                <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm p-2 rounded-full shadow-subtle">
                  <Pill className="h-5 w-5 text-guardian-500" />
                </div>
                ...
                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-subtle text-sm font-medium text-ice-600 flex items-center">
                  ...
                  {language === 'en' ? "Smart Reminders" : "Recordatorios Inteligentes"}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white rounded-lg p-6 shadow-sm text-center">
                <div className="w-14 h-14 bg-guardian-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Pill className="w-7 h-7 text-guardian-500" />
                </div>
                <h3 className="font-semibold mb-2">
                  {language === 'en' ? "Load Medications" : "Cargar Medicamentos"}
                </h3>
                <p className="text-muted-foreground">
                  {language === 'en' 
                    ? "Fill the dispenser compartments with your prescribed medications." 
                    : "Llene los compartimentos del dispensador con sus medicamentos recetados."}
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm text-center">
                ...
                <h3 className="font-semibold mb-2">
                  {language === 'en' ? "Set Your Schedule" : "Establezca Su Horario"}
                </h3>
                <p className="text-muted-foreground">
                  {language === 'en' 
                    ? "Program your medication schedule through our user-friendly app." 
                    : "Programe su horario de medicación a través de nuestra aplicación fácil de usar."}
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm text-center">
                ...
                <h3 className="font-semibold mb-2">
                  {language === 'en' ? "Receive Reminders" : "Reciba Recordatorios"}
                </h3>
                <p className="text-muted-foreground">
                  {language === 'en' 
                    ? "Get alerts when it's time to take your medication and notifications for refills." 
                    : "Reciba alertas cuando sea hora de tomar su medicación y notificaciones para recargas."}
                </p>
              </div>
            </div>
          </div>
