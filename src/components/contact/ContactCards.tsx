...
import { PhoneIcon, MailIcon, MessageSquare, Clock } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
      <div className="glass-panel p-8 flex flex-col items-center text-center transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-lg">
        <div className="h-16 w-16 rounded-full bg-gradient-to-br from-ice-100 to-ice-200 flex items-center justify-center mb-4">
