...
const JourneyTimeline: React.FC<JourneyTimelineProps> = ({ language }) => {
  return (
    <section className="py-10 bg-gradient-to-b from-white to-ice-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-semibold text-guardian-700 mb-2">
          ...
          <div className="relative">
            ...
            {/* 2018 - Foundation */}
            <div className="relative z-10 flex flex-col md:flex-row items-center mb-10">
              <div className="order-2 md:order-1 md:w-1/2 p-4 md:pr-8 text-right">
                <h3 className="text-xl font-semibold text-ice-700 mb-1">2018</h3>
              ...
              <div className="order-1 md:order-2 mb-4 md:mb-0">
                <div className="h-10 w-10 rounded-full bg-ice-100 border-4 border-ice-500 flex items-center justify-center shadow-lg">
                  <FileBadge size={16} className="text-ice-600" />
                </div>
              </div>
            ...
            {/* 2020 - Expansion */}
            <div className="relative z-10 flex flex-col md:flex-row items-center mb-10">
              <div className="order-3 md:w-1/2 p-4 md:pl-8">
                <h3 className="text-xl font-semibold text-guardian-700 mb-1">2020</h3>
                <h4 className="text-lg font-medium mb-2">
              ...
              <div className="order-1 mb-4 md:mb-0">
                <div className="h-10 w-10 rounded-full bg-guardian-100 border-4 border-guardian-500 flex items-center justify-center shadow-lg">
                  <Globe size={16} className="text-guardian-600" />
                </div>
              </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center">
              <div className="order-2 md:order-1 md:w-1/2 p-4 md:pr-8 text-right">
                <h3 className="text-xl font-semibold text-ice-700 mb-1">2024</h3>
                <h4 className="text-lg font-medium mb-2">
              ...
              <div className="order-1 md:order-2 mb-4 md:mb-0">
                <div className="h-10 w-10 rounded-full bg-ice-100 border-4 border-ice-500 flex items-center justify-center shadow-lg">
                  <Sparkles size={16} className="text-ice-600" />
                </div>
              </div>
              <div className="order-3 md:w-1/2"></div>
            </div>
