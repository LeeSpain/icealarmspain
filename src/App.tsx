          ...
          <AuthProvider>
            <Router>
              ...
              <Routes>
                ...
                <Route path="/admin/device-monitoring" element={<AdminDashboard />} />
                <Route path="/admin/device-maintenance" element={<AdminDashboard />} />
                <Route path="/admin/alerts-management" element={<AdminDashboard />} />
                <Route path="/admin/client-onboarding" element={<AdminDashboard />} />
                <Route path="/admin/device-inventory" element={<AdminDashboard />} />
